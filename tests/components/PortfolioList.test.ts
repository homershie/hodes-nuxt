...
const baseWorks = [
  ...
  { id: 'w2', title: 'Work 2', image: '/img/2.jpg', category: ['B', 'C'], imageDimensions: { width: 500, height: 400 } },
...
describe('PortfolioList.vue', () => {
  ...
  it('更新 works 後，清單數量增加', async () => {
    ...
    await wrapper.setProps({ works: [...baseWorks, { id: 'w4', title: 'Work 4', image: '/img/4.jpg', category: ['D'] }] })
